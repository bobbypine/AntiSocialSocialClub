...
def keysearch(key):
    ...
    url = 'https://www.antisocialsocialclub.com/sitemap_products_1.xml?from=6322486855&to=1505417658443'
        ...
        if item is not None:
            ...
            if keyword.lower() in title.lower():
                ...
                for proditems in data['product']['variants']:
                    ...
                    link = 'https://www.antisocialsocialclub.com/cart/{}:1'.format(variant)
                    print('     ',size,'ATC:',link)
                print()
            else:
